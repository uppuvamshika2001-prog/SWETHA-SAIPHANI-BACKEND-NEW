...
import { UnauthorizedError, ConflictError, NotFoundError, InvalidCredentialsError, DatabaseError, } from '../../utils/AppError.js';
    ...
    async login(input) {
        try {
            ...
            if (user.status !== 'ACTIVE') {
                ...
                throw new UnauthorizedError('Account is disabled. Please contact administrator.', 'AUTH_ACCOUNT_DISABLED');
            }
