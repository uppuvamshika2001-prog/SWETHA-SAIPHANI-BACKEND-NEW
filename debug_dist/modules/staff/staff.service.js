...
export class StaffService {
    async create(input) {
        ...
        emailService.sendStaffWelcomeEmail(input.email, `${input.firstName} ${input.lastName}`, input.role, resetToken).catch(err => console.error('Failed to send staff welcome email:', err));
