...
export async function createPurchase(req, res, next) {
    try {
        ...
        const result = await pharmacyService.createPurchase({ ...validated, fileUrl });
...
export async function updatePurchase(req, res, next) {
    try {
        ...
        const fileUrl = req.file ? req.file.path.replace(/\\/g, '/') : undefined;
        const result = await pharmacyService.updatePurchase(req.params.id, validated, fileUrl);
...
export async function deletePurchase(req, res, next) {
    try {
        await pharmacyService.deletePurchase(req.params.id);
...
export async function updateMedicine(req, res, next) {
    try {
        ...
        const medicine = await pharmacyService.updateMedicine(req.params.id, input);
...
export async function updateBatch(req, res, next) {
    try {
        ...
        const batch = await pharmacyService.updateBatch(req.params.id, input);
...
export async function getBill(req, res, next) {
    try {
        const bill = await pharmacyService.getBill(req.params.id);
...
export async function updateBill(req, res, next) {
    try {
        ...
        const bill = await pharmacyService.updateBill(req.params.id, input);
...
export async function deleteBill(req, res, next) {
    try {
        await pharmacyService.deleteBill(req.params.id);
 ...
 */
export async function getLowStockMedicines(req, res, next) {
    try {
...
export async function getDistributorReport(req, res, next) {
    try {
...
export async function getMarginReport(req, res, next) {
    try {
...
export async function getPharmacyReports(req, res, next) {
    try {
...
export async function getPurchasePayments(req, res, next) {
    try {
        const result = await pharmacyService.getPurchasePayments(req.params.id);
        sendSuccess(res, result);
    }
    catch (error) {
 ...
 *       - bearerAuth: []
 */
export async function getReturns(req, res, next) {
    try {
 ...
 *       - bearerAuth: []
 */
export async function processStockReturn(req, res, next) {
    try {
        const pharmacistId = req.user?.userId;
 ...
 *       - bearerAuth: []
 */
export async function getStockReturns(req, res, next) {
    try {
