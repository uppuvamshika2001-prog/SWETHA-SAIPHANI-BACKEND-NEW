...
import { createLabOrder, getLabOrders, getMyLabOrders, getLabOrder, getOrderParameters, updateLabOrderStatus, submitLabResult, getLabResult, deleteLabResult, createLabTest, getLabTests, updateLabTest, deleteLabTest, deleteLabOrder, downloadLabReport, confirmLabOrderPayment } from './lab.controller.js';
...
router.patch('/orders/:id/confirm-payment', roleGuard(UserRole.ADMIN, UserRole.RECEPTIONIST), confirmLabOrderPayment);
