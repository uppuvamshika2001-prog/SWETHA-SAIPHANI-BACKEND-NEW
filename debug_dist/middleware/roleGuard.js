...
export const staffOnly = roleGuard(UserRole.ADMIN, UserRole.DOCTOR, UserRole.RECEPTIONIST, UserRole.PHARMACIST, UserRole.LAB_TECHNICIAN);
export const clinicalStaff = roleGuard(UserRole.ADMIN, UserRole.DOCTOR, UserRole.RECEPTIONIST);
export const medicalStaff = roleGuard(UserRole.ADMIN, UserRole.DOCTOR);
export const medicalReadAccess = roleGuard(UserRole.ADMIN, UserRole.DOCTOR, UserRole.PHARMACIST);
// Billing access - only ADMIN and RECEPTIONIST can generate bills
export const billingAccess = roleGuard(UserRole.ADMIN, UserRole.RECEPTIONIST);
